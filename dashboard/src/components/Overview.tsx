...
export function Overview({ snapshot, onKill, onKillAll, inspectProcess, adoptPort, createGuard, updateGuard, deleteGuard, refresh, onOpenLogs }: Props) {
  const { T } = useLang()
...
function ProcessTable({ ports, docker, pm2, managed, protectedPorts, onKill, onKillAll, onProtect, onInspect, onLogs, onAdopt }: {
