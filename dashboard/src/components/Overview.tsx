...
function ProcessTable({ ports, docker, onKill, onKillAll }: { ports: PortInfo[]; docker: any[]; onKill: (port: number, proc: string | null) => void; onKillAll: () => void }) {
  const { T } = useLang()
